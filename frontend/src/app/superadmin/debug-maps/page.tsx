        ...
        <div className="min-h-screen bg-white dark:bg-[#08090f] p-8 md:p-16 space-y-12 font-sans overflow-hidden relative">
            ...
            <header className="relative z-10">
                ...
                <p className="text-slate-500 font-medium tracking-tight max-w-xl">
                    Ermöglicht das sofortige Testen von Google Maps-Integrationen, Schlüsseln und Servicestatus im System.
                </p>
            </header>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 relative z-10">
                ...
                <div className="bg-white dark:bg-slate-900/50 p-10 rounded-[3rem] border border-slate-100 dark:border-white/5 shadow-2xl space-y-8">
                    <h3 className="text-lg font-black text-slate-900 dark:text-white uppercase tracking-tight flex items-center gap-3">
                        <ShieldCheck className="text-indigo-500" /> Servicestatus
                    </h3>
                            ...
                            <div key={serv.id} className="flex items-center justify-between p-6 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-transparent hover:border-slate-100 transition duration-300">
                                ...
                                {serv.active ? (
                                    ...
                                    <div className="flex items-center gap-2 text-slate-400">
                                        ...
                                        <span className="text-[10px] font-black uppercase tracking-widest">Ausstehend</span>
                                    </div>
                                )}
                            </div>
                        ))}
                ...
                <div className="bg-white dark:bg-slate-900/50 p-10 rounded-[3rem] border border-slate-100 dark:border-white/5 shadow-2xl space-y-8">
                    <h3 className="text-lg font-black text-slate-900 dark:text-white uppercase tracking-tight flex items-center gap-3">
                        <MapPin className="text-blue-500" /> Autocomplete-Test
                    </h3>
                    <div>
                        <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4">Versuchen Sie, eine Adresse einzugeben</p>
                        <AddressPicker
                            ...
                            placeholder="Suchen Sie eine Adresse..."
                        />
                    </div>
                    <div className="p-6 bg-blue-500/5 rounded-2xl border border-blue-500/10">
                        <p className="text-[11px] font-medium text-slate-500 leading-relaxed">
                            Dieser Bereich testet die <span className="text-blue-500 font-bold">Places API</span>. Wenn während der Eingabe Vorschläge erscheinen, funktioniert der Schlüssel einwandfrei.
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-slate-900/50 p-10 rounded-[3rem] border border-slate-100 dark:border-white/5 shadow-2xl space-y-8">
                    <h3 className="text-lg font-black text-slate-900 dark:text-white uppercase tracking-tight flex items-center gap-3">
                        <Route className="text-purple-500" /> Entfernungs- / Preistest
                    </h3>
                    <button
                        ...
                        <div className="space-y-4 animate-in slide-in-from-top-4 duration-500">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-6 bg-slate-50 dark:bg-slate-800/50 rounded-2xl text-center">
                                    <p className="text-[10px] font-black text-slate-400 uppercase leading-none mb-2">Entfernung</p>
                                    <p className="text-xl font-black text-slate-900 dark:text-white">{distanceResult.distanceKm} KM</p>
                                </div>
                                <div className="p-6 bg-slate-50 dark:bg-slate-800/50 rounded-2xl text-center">
                                    <p className="text-[10px] font-black text-slate-400 uppercase leading-none mb-2">Dauer</p>
                                    <p className="text-xl font-black text-slate-900 dark:text-white">{distanceResult.durationMin} Min.</p>
                                </div>
                            </div>
                            <div className="p-6 bg-emerald-500 text-white rounded-2xl shadow-xl shadow-emerald-500/20 text-center">
                                <p className="text-[10px] font-black text-emerald-100 uppercase leading-none mb-2">Berechneter Preis</p>
            ...
            <footer className="pt-12 border-t border-slate-100 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 relative z-10">
                <div className="flex items-center gap-6">
                    <div className="flex flex-col">
                        <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Gerätestandort (Geolokalisierung)</span>
                        <div className="flex items-center gap-2 text-slate-900 dark:text-white font-black text-sm uppercase">
                            <Navigation size={14} className="text-blue-500" /> Browser GPS: Aktiv
                        </div>
                    </div>
                </div>
