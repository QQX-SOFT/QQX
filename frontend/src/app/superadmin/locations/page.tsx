                ...
                <div className="divide-y divide-slate-100 dark:divide-white/5">
                    {loading ? (
                        ...
                        <div className="p-12 text-center">
                            ...
                            <button className="mt-4 bg-indigo-500 hover:bg-indigo-600 text-white px-8 py-3 rounded-2xl font-bold transition">Ersten Standort hinzufügen</button>
                        </div>
                    ) : (
                        locations.map((loc: LocationData) => (
                            <div key={loc.id} className="p-8 flex items-center justify-between hover:bg-slate-50/50 dark:hover:bg-white/5 transition group">
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            <span className="text-[10px] font-black uppercase px-2 py-0.5 bg-indigo-500/10 text-indigo-500 rounded-lg">{loc.tenant?.name}</span>
                                        </div>
                                ...
                                <button className="p-3 bg-slate-100 dark:bg-white/5 rounded-xl opacity-0 group-hover:opacity-100 transition">
