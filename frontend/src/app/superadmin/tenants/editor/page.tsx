...
export default function TenantEditorPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0b0f1a] text-slate-200 p-8 lg:p-12">
            <div className="max-w-4xl mx-auto space-y-12">
                {/* Header */}
                <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        <div className="flex items-center gap-3 mb-4">
                            <Link href="/superadmin/tenants" className="p-2 bg-white/5 rounded-lg text-slate-400 hover:bg-white/10 transition">
                                <ArrowLeft size={20} />
                            </Link>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-950/50 border border-white/10 rounded-2xl px-6 py-4 outline-none focus:border-indigo-500 transition text-white font-bold"
                                    value={formData.name}
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-3 bg-slate-950/50 border border-white/10 rounded-2xl px-6 py-4 focus-within:border-indigo-500 transition">
                                    <input
                                        type="text"
                                        required
                                        placeholder="mueller"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <select
                                        className="w-full bg-slate-950/50 border border-white/10 rounded-2xl pl-14 pr-6 py-4 outline-none focus:border-indigo-500 transition text-white font-bold appearance-none"
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-950/50 border border-white/10 rounded-2xl pl-14 pr-6 py-4 outline-none focus:border-indigo-500 transition text-white font-bold"
